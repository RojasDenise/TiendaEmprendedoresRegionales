...
-- Nivel 2: Entidades de Usuario y Localizaci�n
SELECT * FROM Cliente;
SELECT * FROM Usuario;
SELECT * FROM Ciudad;

-- Nivel 3: Operaciones de Cat�logo y Log�stica
...
CREATE TABLE Usuario (
  ...
  email VARCHAR(50) NOT NULL,
  contrase�a VARCHAR(255) NOT NULL,
  rese�a VARCHAR(255) NULL,
  nombreEmprendimiento VARCHAR(50) NULL,
  id_estado INT NOT NULL,
  id_rol INT NOT NULL,
  fecha_ultima_conexion DATETIME NULL, -- Para auditor�a, se determina estado activo/inactivo
...
UPDATE Usuario
SET contrase�a = '$2b$10$lg14ZWzRxC3hHZrdUW66W.JpmmXb9On4VCN0Ap8u8NOvZnrggOk8K'
...
-- =============================================
-- 3. Trigger: actualizaci�n de stock y estado
-- =============================================
...
-- 2. Migrar mensajes existentes usando la relaci�n vieja Reclamo.id_mensaje
UPDATE mr
...
-- 6. Agregar id_usuario para saber qui�n escribi� el mensaje
ALTER TABLE Mensaje_Reclamo
