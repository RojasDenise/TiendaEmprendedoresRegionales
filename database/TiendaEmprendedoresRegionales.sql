...
-- =============================================
-- NIVEL 2 - USUARIOS Y LOCALIZACI�N
-- =============================================
SELECT * FROM Cliente;
SELECT * FROM Usuario;
SELECT * FROM Ciudad;
...
VALUES ('Artesan�as'), ('Accesorios'), ('Gastronom�a'), ('Textiles'), ('Decoraci�n');
GO
...
-- =============================================
-- 2. ENTIDADES PRINCIPALES Y LOCALIZACI�N
-- =============================================
...
-- =============================================
-- 6. TRIGGER: ACTUALIZACI�N DE STOCK Y ESTADO
-- =============================================
